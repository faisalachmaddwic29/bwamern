                ...
                <div className="col-auto pr-5" style={{ width: 530 }}>
                    ...
                    <div className="row mt-5 ">
                        <div className="col-auto" style={{ marginRight: 30 }}>
                            ...
                            />
                            <h6 className="mt-3">
                                {props.data.travelers} <span className="text-grey-500 font-weight-light">
                                    Travelers
                                </span>
                            </h6>
                        </div>
                        <div className="col-auto" style={{ marginRight: 30 }}>
                            ...
                            />
                            <h6 className="mt-3">
                                {props.data.treasures} <span className="text-grey-500 font-weight-light">
                                    Travelers
                                </span>
                            </h6>
                        </div>
                        <div className="col-auto">
                            ...
                            <h6 className="mt-3">
                                {props.data.cities} <span className="text-grey-500 font-weight-light">
                                    Travelers
                                </span>
                            </h6>
                        </div>
                ...
                <div className="col-6 pl-5">
                    <div style={{ width:520, height:410 ,position:"relative"}}>
                        ...
                        <img 
                            ...
                            className="img-fluid posisition-absolute" 
                        />
                    </div>
                </div>
            </div>
